...
- [x] 3.1 Build succeeds with 0 warnings: `dotnet build BeaverWorks.sln --no-restore` — 88bb4ae
- [x] 3.2 Full solution test run passes: `dotnet test BeaverWorks.sln --no-build` — 88bb4ae

#### Manual

- [x] 3.3 Plan image renders letterboxed correctly for a non-matching aspect ratio — 88bb4ae
- [x] 3.4 Clicking inside the image opens the new-task dialog; clicking the letterbox margin does nothing — 88bb4ae
- [x] 3.5 Creating a task with only a title shows a Planned-colored marker at the exact clicked point — 88bb4ae
- [x] 3.6 Save/close/reopen reproduces the marker at the identical position — 88bb4ae
- [x] 3.7 Two tasks at distinct points both survive reopen at their distinct positions — 88bb4ae
- [x] 3.8 Markers track the image correctly after a window resize — 88bb4ae
